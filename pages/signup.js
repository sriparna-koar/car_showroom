...
//           <Link href={'/signup'} passHref><h1 className="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
//                   Sign up for your account
//               </h1>
//               </Link>
//               <Link href={'/login'} passHref><p className="text-sm font-light text-gray-500 dark:text-gray-400">
